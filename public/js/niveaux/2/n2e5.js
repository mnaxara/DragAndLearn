            ...
            drop: function () { // Lorsque la cellule est dropé
                ...
                */
                if ($(this).attr('id') === 'droppable5'){
                    $('#rainbow').css('border-image','linear-gradient(#f6b73c, #4d9f0c) 30');
                }
                if ($(this).attr('id') === 'droppable6'){
                    $('#rainbow').css('border', '25px solid');
                }
                if ($(this).attr('id') === 'droppable7'){
                    $('#h1').css('border-style', 'dotted');
                } 
                if ($(this).attr('id') === 'droppable8'){
                    $('p').css('border', '1px dashed black');
                }
                if ($(this).attr('id') === 'droppable9'){
                    $('.brd').css('border', '1px dashed black');
                }
                check(id);
